...
pub(crate) async fn permission_by_email(
...
pub(crate) async fn ensure_absent_by_email(
    session: &OAuthSession,
    member_id: &str,
    list_url: &str,
    permissions_field: &str,
    ...
    HasRole: Fn(&serde_json::Value) -> bool,
{
    ...
    pub(crate) async fn ensure_present(&self, member_id: &str) -> Result<(), CloudHomeError> {
    ...
    pub(crate) async fn ensure_absent(&self, member_id: &str) -> Result<(), CloudHomeError> {
