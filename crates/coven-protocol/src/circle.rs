...
pub struct CircleCloseParticipant {
    pub device_id: crate::store_commit::StoreDeviceId,
...
#[serde(transparent)]
pub struct CircleOperationId(crate::write::WriteId);

impl CircleOperationId {
    pub fn from_write_id(write_id: crate::write::WriteId) -> Self {
        Self(write_id)
    }
    ...
    pub fn placeholder(seed: &str) -> Self {
        Self::from_write_id(crate::write::WriteId::from_generated(seed.to_string()))
    }
    ...
    pub fn finalization_write_id(&self) -> crate::write::WriteId {
        crate::write::WriteId::from_generated(
            crate::store_commit::ObjectHash::digest(
                &[
    ...
    pub fn cancellation_write_id(&self) -> crate::write::WriteId {
        crate::write::WriteId::from_generated(
            crate::store_commit::ObjectHash::digest(
                &[
...
impl CircleEpochCloseId {
    pub fn from_operation_id(operation_id: &CircleOperationId) -> Self {
...
pub enum CircleOperationBlock {
    ...
    /// re-issues.
    PositionLost {
        winner_commit: crate::store_commit::ObjectHash,
    },
}
...
macro_rules! generated_hex_id {
    ($name:ident, $domain:ident) => {
        ...
        impl $name {
            pub fn generate(ids: &dyn coven_foundation::id_provider::IdProvider) -> Self {
...
#[derive(Clone)]
pub struct RowRoutingKey([u8; 32]);
...
pub fn row_routing_id(key: &RowRoutingKey, table: &str, row_id: &str) -> RowRoutingId {
