...
pub fn test_store_binding() -> crate::objects::StoreProviderBinding {
    crate::objects::StoreProviderBinding::S3 {
        endpoint: crate::objects::S3EndpointBinding::Aws {
...
pub fn test_device_binding() -> crate::objects::ProviderDeviceBinding {
    crate::objects::ProviderDeviceBinding {
        principal: crate::objects::ProviderPrincipalId::Aws {
            account_id: "123456789012".to_string(),
            principal: crate::objects::AwsPrincipal::Root,
        },
    }
}

pub fn test_exact_receipt() -> ExactSlotProbeReceipt {
    let probe_id = ProviderProbeId::from_bytes([7; 32]);
    let slot = crate::objects::ObjectSlot::logical("store-v1/probes/exact".to_string()).unwrap();
    ...
    let accepted = crate::objects::ExactObjectRef::new(
        slot.clone(),
        first.len() as u64,
