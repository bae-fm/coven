...
impl OwnerRecoveryNode {
    ...
    pub fn parse_at(
        ...
        let node: Self = crate::objects::decode_protocol_object(bytes)?;
...
pub type StoreDeviceRegistration = Signed<StoreDeviceRegistrationBody>;

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ReferencedStoreDeviceRegistration {
...
impl ReferencedStoreDeviceRegistration {
    ...
    pub fn value(&self) -> &StoreDeviceRegistration {
        &self.value
    }
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ActivatedStoreDeviceRegistration {
...
impl ActivatedStoreDeviceRegistration {
    ...
    pub fn registration(&self) -> &ReferencedStoreDeviceRegistration {
        &self.registration
    }
    ...
    pub fn activation(&self) -> &StoreDeviceRegistrationActivation {
        &self.activation
    }
...
impl StoreDeviceRegistration {
    ...
    pub fn parse_at(
        ...
        let registration: Self = crate::objects::decode_protocol_object(bytes)?;
