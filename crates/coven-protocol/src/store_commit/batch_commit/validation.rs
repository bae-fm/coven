...
pub(crate) fn validate_stream_activations(
    ...
    for activation in activations {
        crate::objects::verify_store_root(store_root_hash, activation.store_root_hash())?;
...
pub(super) fn validate_candidate_object_path(
    ...
    match candidate {
        ...
        CandidateExclusiveObjectRef::CircleEpochCloseIntent {
            ...
            let expected = format!(
                "{}.json",
                crate::circle::circle_epoch_close_intent_semantic_prefix(
                    *circle_id,
                    reference.close_id,
        ...
        CandidateExclusiveObjectRef::CircleEpochCloseOutcome {
            ...
            let expected = format!(
                "{}.json",
                crate::circle::circle_epoch_close_outcome_semantic_prefix(
                    *circle_id,
                    reference.close_id,
                )
            );
