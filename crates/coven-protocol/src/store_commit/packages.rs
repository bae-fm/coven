...
pub struct CircleActivationObjects {
    ...
    pub close_intent: Option<crate::circle::CircleEpochCloseIntentRef>,
...
pub struct StoreControl {
    pub transition: crate::membership::MergeMembershipHeadTransition,
}
...
impl OwnerPromotionRequestBody {
    fn validate_shape(
        ...
        crate::objects::verify_store_root(root.store_root_hash, self.store_root_hash)?;
...
pub type OwnerPromotionAcceptance = Signed<OwnerPromotionAcceptanceBody>;
        ...
        }
        {
            ...
            if membership.first_slot().logical_key() != membership_key
                ...
                || matches!(
                    ...
                    (
                        crate::objects::PhysicalObjectLocator::Opaque(left),
                        crate::objects::PhysicalObjectLocator::Opaque(right),
                    ) if left == right
                )
            {
                return Err(StoreProtocolError::OwnerPromotionMismatch);
...
pub enum CandidateExclusiveObjectRef {
    ...
    CircleEpochCloseIntent {
        circle_id: CircleId,
        reference: crate::circle::CircleEpochCloseIntentRef,
    },
    CircleEpochCloseOutcome {
        circle_id: CircleId,
        reference: crate::circle::CircleEpochCloseOutcomeRef,
    },
...
pub enum DeviceJoinAttemptDecisionRef {
    Attempt(DeviceJoinAttemptId),
    Abandoned(crate::store_commit::DeviceJoinAbandonmentRef),
}

impl DeviceJoinAttemptDecisionRef {
    pub fn attempt_id(&self) -> DeviceJoinAttemptId {
        match self {
            Self::Attempt(attempt_id) => *attempt_id,
