...
use super::*;
use crate::membership::founder_entry;
use crate::{audience_package, remote_object};
...
fn fixture() -> Fixture {
    ...
    let founder_grant =
        crate::causal_grants::MembershipGrantId::from_test_label("store-a founder grant");
    let provider_admin = crate::provider::FounderProviderAdminGrant::from_test_label("store-a");
...
struct CleanupFixture {
    ...
    cancellation: crate::store_commit::DeviceJoinOutcomeRef,
    administrator_terminal: crate::store_commit::device_join_exchange::ProviderAdminJoinTerminal,
    joiner_terminal: crate::store_commit::device_join_exchange::JoinerJoinTerminal,
    membership: StoreMembershipStateRef,
    provider_admin_grant: crate::provider::ProviderAdminGrantId,
    access_locator: crate::provider::ProviderAccessLocator,
}

fn cleanup_fixture(fixture: &Fixture, joiner: &UserKeypair) -> CleanupFixture {
    use crate::store_commit::device_join_exchange as exchange;
    ...
    let cancellation = crate::store_commit::DeviceJoinOutcomeRef::Cancelled {
        attempt: attempt_ref,
