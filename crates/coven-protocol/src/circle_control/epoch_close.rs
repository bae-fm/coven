...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseParticipant {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseIntentBody {
...
impl CircleEpochCloseIntentBody {
    pub(super) fn verify_shape(&self) -> bool {
        self.removal.verify()
            ...
            && matches!(
                self.removal.change,
                crate::circle_roster::CircleRosterChange::RemoveMember { .. }
            )
    }
}
...
impl CircleEpochClose {
    pub(super) fn verify_shape(&self, circle_id: CircleId) -> bool {
        crate::store_commit::validate_commit_frontier(&self.provisional_frontier).is_ok()
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseResponseBody {
    pub store_root_hash: ObjectHash,
    pub circle_id: CircleId,
    pub close_id: CircleEpochCloseId,
...
pub type CircleEpochCloseResponse = Signed<CircleEpochCloseResponseBody>;
...
impl CircleEpochCloseResponse {
    ...
    pub fn verify_for(
        ...
        control.verify()
            ...
            && crate::store_commit::validate_commit_frontier(&self.frontier).is_ok()
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseExclusionBody {
    pub store_root_hash: ObjectHash,
    pub circle_id: CircleId,
    pub close_id: CircleEpochCloseId,
    pub close_control: CircleControlCoord,
...
pub type CircleEpochCloseExclusion = Signed<CircleEpochCloseExclusionBody>;
...
impl CircleEpochCloseResponseSlotValue {
    ...
    pub fn parse(bytes: &[u8]) -> Result<Self, CircleTransitionError> {
...
impl CircleEpochCloseSettlement {
    pub fn registration(&self) -> &StoreDeviceRegistrationRef {
        match self {
    ...
    pub fn response_frontier(&self) -> Option<&CommitFrontier> {
        match self {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseOutcomeBody {
    pub store_root_hash: ObjectHash,
    pub circle_id: CircleId,
    pub close_id: CircleEpochCloseId,
    pub close_control: CircleControlCoord,
...
pub type CircleEpochCloseOutcome = Signed<CircleEpochCloseOutcomeBody>;
...
impl CircleEpochCloseOutcome {
    ...
    pub(super) fn verify_shape(&self, control: &PreparedCircleControl) -> bool {
        ...
        control.verify()
            ...
            && crate::store_commit::validate_commit_frontier(&self.cutoff).is_ok()
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct CircleEpochCloseCancellationBody {
    pub store_root_hash: ObjectHash,
    pub circle_id: CircleId,
    pub close_id: CircleEpochCloseId,
    pub close_control: CircleControlCoord,
...
pub type CircleEpochCloseCancellation = Signed<CircleEpochCloseCancellationBody>;
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case", deny_unknown_fields)]
pub enum CircleEpochCloseSlotValue {
    Outcome(CircleEpochCloseOutcome),
    Cancellation(CircleEpochCloseCancellation),
}
