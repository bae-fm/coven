...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct StoreEncryptedProtocolObjectDomain(pub(super) ProtectedObjectDomain);
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct SignedStoreProtocolObjectDomain(pub(super) ProtectedObjectDomain);

/// A domain protected by a Circle epoch key.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct CircleProtocolObjectDomain(pub(super) ProtectedObjectDomain);

/// A domain whose canonical bytes already carry recipient-specific encryption.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct RecipientSealedProtocolObjectDomain(pub(super) ProtectedObjectDomain);
