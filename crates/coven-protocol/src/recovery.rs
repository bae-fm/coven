...
pub struct ActivatedContinuation {
    ...
    pub registration: crate::store_commit::StoreDeviceRegistrationRef,
    pub registration_bytes: Vec<u8>,
    pub registration_prepared: crate::objects::PreparedExactObject,
    pub initial_ack: crate::store_commit::StoreAckRef,
...
pub struct OwnerRecoveryAuthority {
    ...
    pub owner_grant: crate::membership::MembershipGrantId,
    pub recovery: crate::store_commit::OwnerRecoveryCursor,
