...
use crate::circle::{
    ...
    CircleMetadataCoord, CircleRosterCoord,
};
...
pub(crate) const STORE_MEMBERSHIP_ROLLUP_PREFIX: &str = "store-v1/membership-rollups/";
...
const MEMBERSHIP_ROLLUP_DOMAIN: &[u8] = b"coven.store-membership-rollup.v1\0";
