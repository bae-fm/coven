...
pub enum RowBlobAuthority {
    ...
    Remote(crate::audience_package::PackageAudience),
}

pub enum BlobOpeningAuthority<'a> {
    Store,
    Circle {
        circle_id: crate::circle::CircleId,
        control: &'a crate::circle::CircleControlCoord,
...
pub enum BlobOpeningAuthorityError {
    ...
    CircleAuthorityMismatch { circle_id: crate::circle::CircleId },
}
...
impl RowBlobAuthority {
    pub fn audience(&self) -> crate::circle::Audience {
        match self {
            Self::Local => crate::circle::Audience::Local,
            Self::PendingRemote(locator::RemoteAudience::Store) => crate::circle::Audience::Store,
            Self::PendingRemote(locator::RemoteAudience::Circle(circle_id)) => {
                crate::circle::Audience::Circle(*circle_id)
            }
            Self::Remote(crate::audience_package::PackageAudience::Store) => {
                crate::circle::Audience::Store
            }
            Self::Remote(crate::audience_package::PackageAudience::Circle {
                circle_id, ..
            }) => crate::circle::Audience::Circle(*circle_id),
        }
    }

    pub fn opening_authority<'a>(
        &'a self,
...
impl RowBlobRef {
    ...
    pub fn plaintext_hash(&self) -> crate::store_commit::ObjectHash {
        self.plaintext_hash
    }
...
pub struct DeferredLocalBlobDrop {
    ...
    pub id: String,
    pub size: u64,
    pub plaintext_hash: crate::store_commit::ObjectHash,
    pub locator_hash: crate::store_commit::ObjectHash,
