...
pub(crate) fn author_exclusion_activation_for_candidate_on(
    ...
    let frontier = crate::database::StoreDatabase::materialized_frontier_on(conn, None)?
        .into_values()
...
pub(crate) fn load_author_exclusion_activation_locator_on(
    ...
    let retained = crate::database::StoreDatabase::load_retained_merge_materialization_by_ref_on(
        conn,
        root,
...
pub(crate) fn validate_terminal_nonactivation_authority_on(
    ...
    match durable.proof() {
        ...
        crate::protocol::remote_object::CandidateNonactivationProof::MergeMembershipGrantRevocation {
            ...
            if crate::database::StoreDatabase::materialized_commit_ref_on(
                conn,
                &stream_id.to_string(),
                *sequence,
            )?
