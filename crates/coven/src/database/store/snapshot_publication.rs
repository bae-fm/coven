...
impl StoreDatabase {
    ...
    pub(crate) async fn capture_snapshot_image_for_test(
        ...
        self.connection
            .call(move |connection| {
                crate::sync::create_snapshot_with_host_blobs(
                    connection,
                    &root,
                    &temp_dir,
                    &tables,
    ...
    > {
        self.connection
            .call(move |connection| {
                ...
                let snapshot = crate::sync::create_snapshot_with_host_blobs(
                    connection,
                    &root,
                    &temp_dir,
                    &tables,
    ...
    > {
        self.connection
            .call(move |connection| {
                require_no_unpublished_store_writes(connection)?;
                let snapshot = crate::sync::create_circle_snapshot_with_host_blobs(
                    connection,
                    &root,
                    &temp_dir,
                    &tables,
    ...
    pub(crate) async fn capture_circle_snapshot_at_cutoff(
    ...
    ) -> Result<crate::sync::CreatedSnapshot, DbError> {
        ...
        self.connection
            .call(move |connection| {
                ...
                crate::sync::create_circle_snapshot_with_host_blobs(
                    &replay,
                    &root,
                    &temp_dir,
                    &tables,
...
fn require_no_unpublished_store_writes(connection: &rusqlite::Connection) -> Result<(), DbError> {
