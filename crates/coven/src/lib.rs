...
pub use storage::{
    create_cloud_home, generate_restore_code, write_cloud_object_stream, AwsPrincipal, BlobBody,
    BoxPartSink, CloudAccessOutcome, CloudAccessState, CloudFileReadError, CloudHome,
    CloudHomeError, CloudHomeJoinInfo, CloudKitAcceptedShareRecord, CloudKitAtomicCreateBatch,
    CloudKitEnvironment, CloudKitOps, CloudKitProviderIdentity, CloudKitRecordCreate,
    ...
    ExactSlotStorage, GoogleDriveCorpus, ObjectSlot, PartSink, PhysicalObjectLocator,
