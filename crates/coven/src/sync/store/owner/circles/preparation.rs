...
> {
    ...
    let policy_objects = {
        ...
        let roster_successor = match roster_policy {
            ...
            crate::protocol::circle::CircleRosterDraftPolicy::Successor { predecessor, entry } => {
        ...
        if let Some(finalization) = draft.close_finalization.take() {
            ...
            let outcome_ref = crate::protocol::circle::CircleEpochCloseOutcomeRef::from_outcome(
                &outcome,
    ...
    let (creation, commit, commit_ref, policy, prepared_objects) = {
        ...
        let (creation, additional_prepared) = match &request {
            ...
            CircleOperationRequest::RemoveMember(request) => {
                ...
                let close_id =
                    crate::protocol::circle::CircleEpochCloseId::from_operation_id(&operation_id);
                ...
                .await?;
                let intent_ref = crate::protocol::circle::CircleEpochCloseIntentRef::from_intent(
                    &intent,
