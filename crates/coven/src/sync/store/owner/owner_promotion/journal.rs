...
fn nonactivation_commit(
    nonactivation: &crate::protocol::remote_object::CandidateNonactivation,
) -> Result<crate::protocol::store_commit::StoreBatchCommit, String> {
    nonactivation
        .validate()
...
fn transition_matches_acceptance(
    ...
    validate_prepared_transition(transition).is_ok()
        ...
        && matches!(
            &entry.change,
            crate::protocol::membership::MembershipChange::SetMember {
                user_pubkey,
                role: StoreMembershipRoleGrant::Owner {
                    recovery: crate::protocol::membership::OwnerRecoveryAnchorRef::Promotion {
...
fn finalization_receipt_matches_acceptance(
...
) -> bool {
    {
        ...
        let crate::protocol::membership::MembershipChange::SetMember { wrapped_key, .. } =
