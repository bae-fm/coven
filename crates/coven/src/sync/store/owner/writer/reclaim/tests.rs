...
fn claim_registration(label: &str) -> crate::protocol::store_commit::StoreDeviceRegistrationRef {
...
fn claim_control(label: &str, seq: u64) -> CircleControlCoord {
    CircleControlCoord {
        ...
        stream_id: crate::protocol::causal_grants::AuthorStreamId::from_digest(ObjectHash::digest(
            label.as_bytes(),
        )),
...
fn claim_image(label: &str) -> crate::protocol::store_commit::SnapshotImageRef {
    crate::protocol::store_commit::SnapshotImageRef {
