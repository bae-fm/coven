...
pub(crate) async fn select_staged_circle_decisions(
    ...
    query_db: &crate::database::StoreDatabase,
...
mod tests {
    ...
    async fn snapshot_image_is_durable_before_metadata_can_be_created() {
        ...
        let completed =
            drain_outbound_store_snapshot(&storage, &crate::database::StoreDatabase::new(&db))
                .await
