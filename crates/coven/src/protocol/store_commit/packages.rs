...
pub struct CircleActivationObjects {
    ...
    pub close_intent: Option<crate::protocol::circle::CircleEpochCloseIntentRef>,
    pub close_outcome: Option<crate::protocol::circle::CircleEpochCloseOutcomeRef>,
    pub close_cancellation: Option<crate::protocol::circle::CircleEpochCloseCancellationRef>,
...
pub struct StoreControl {
    pub transition: crate::protocol::membership::MergeMembershipHeadTransition,
}
...
pub(crate) fn derive_owner_promotion_grant(
    store_root_hash: ObjectHash,
    promotion_id: OwnerPromotionId,
    member_pubkey: &str,
) -> MembershipGrantId {
...
pub(crate) enum OwnerPromotionStaleReason {
...
pub enum CandidateExclusiveObjectRef {
    ...
    CircleEpochCloseIntent {
        circle_id: CircleId,
        reference: crate::protocol::circle::CircleEpochCloseIntentRef,
    },
    CircleEpochCloseOutcome {
        circle_id: CircleId,
        reference: crate::protocol::circle::CircleEpochCloseOutcomeRef,
    },
    CircleEpochCloseCancellation {
        circle_id: CircleId,
        reference: crate::protocol::circle::CircleEpochCloseCancellationRef,
    },
    CircleAccess {
        circle_id: CircleId,
...
pub enum StoreCommitBody {
    ...
    ReclaimAuthorization {
        authorization: Box<crate::protocol::reclaim::ReclaimAuthorizationRef>,
    },
    ReclaimReceipt {
        receipt: Box<crate::protocol::reclaim::ReclaimReceiptRef>,
    },
