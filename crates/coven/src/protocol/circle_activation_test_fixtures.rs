...
/// granted.
pub(crate) struct TestCircleActivation {
    pub(crate) circle_id: crate::protocol::circle::CircleId,
    pub(crate) control: crate::protocol::circle::PreparedCircleControl,
    pub(crate) owner_pubkey: String,
    pub(crate) current: CircleCurrentState,
}

pub(crate) fn test_circle_activation(label: &str, active: bool) -> TestCircleActivation {
