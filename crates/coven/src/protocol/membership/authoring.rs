...
impl MembershipChain {
    ...
    pub(crate) fn signed_promote_member_in_stream_with_wrapped_key_for_test(
        ...
        let intended_owner_grant = crate::protocol::store_commit::derive_owner_promotion_grant(
            store_root_hash,
            promotion_id,
            &user_pubkey,
        );
        ...
        let activation_commit = crate::protocol::store_commit::StoreBatchCommitRef {
