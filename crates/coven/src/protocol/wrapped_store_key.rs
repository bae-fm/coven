...
pub(crate) struct WrappedStoreKey {
...
impl WrappedStoreKey {
    ...
    /// be adopted.
    pub(crate) fn verify_and_unwrap<'a>(
        &self,
        store_id: &str,
        recipient_pubkey: &str,
...
#[serde(deny_unknown_fields)]
pub(crate) struct WrappedStoreKeyRef {
...
impl WrappedStoreKeyRef {
    pub(crate) fn semantic_prefix(&self) -> String {
        format!(
            "keys/{}/{}/{}/{}",
...
#[serde(deny_unknown_fields)]
pub(crate) struct PreparedWrappedStoreKey {
    pub reference: WrappedStoreKeyRef,
    pub object: PreparedExactObject,
}

impl PreparedWrappedStoreKey {
    pub(crate) fn validate(&self) -> Result<WrappedStoreKey, StorageError> {
