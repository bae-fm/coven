...
impl CandidateObjectGraph {
    pub(crate) fn from_commit(
        ...
        for candidate in &manifest.objects {
            match candidate {
                crate::protocol::store_commit::CandidateExclusiveObjectRef::StorePackage(reference) => {
                    objects.push(CandidateExclusiveObjectDomain::StorePackage {
                        reference: reference.clone(),
                    });
                }
                crate::protocol::store_commit::CandidateExclusiveObjectRef::CirclePackage(reference) => {
                    objects.push(CandidateExclusiveObjectDomain::CirclePackage {
                        reference: reference.clone(),
                    });
                }
                crate::protocol::store_commit::CandidateExclusiveObjectRef::CircleAccess {
                    circle_id,
                    access,
                } => {
                ...
                crate::protocol::store_commit::CandidateExclusiveObjectRef::CircleEpochCloseIntent {
                    circle_id,
                    reference,
                } => {
                ...
                crate::protocol::store_commit::CandidateExclusiveObjectRef::CircleEpochCloseOutcome {
                    circle_id,
                    reference,
                } => {
                ...
                crate::protocol::store_commit::CandidateExclusiveObjectRef::CircleEpochCloseCancellation {
                    circle_id,
                    reference,
                } => {
