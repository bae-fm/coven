...
pub(crate) use gate::{
    ...
    prune_ineligible_scoped_rows, retain_referenced_ancestors, retain_snapshot_audience_rows,
...
pub use operation_models::{
    ...
    OwnerRecoveryPublication, PreparedLocalDeviceRegistrationRow, PreparedSnapshotBlob,
    PublishedCircleSnapshot, PublishedStoreSnapshot, StoreSnapshotPublicationStage,
};
...
pub use store::{
    ...
    CircleDiscardGround, CreatedCircleSnapshot, CreatedSnapshot, DeviceJoinJournalStore,
