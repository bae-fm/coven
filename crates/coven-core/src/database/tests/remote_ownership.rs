...
async fn repeated_exact_delete_resets_retry_state_without_duplication() {
    ...
    db.call(move |conn| Database::enqueue_delete_on(conn, &delete_stored, "2026-07-16T10:00:00Z"))
        .await
    ...
    db.call(move |conn| Database::enqueue_delete_on(conn, &retry_stored, "2026-07-16T10:01:00Z"))
        .await
