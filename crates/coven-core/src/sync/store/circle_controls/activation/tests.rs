...
fn roster_head(
    ...
    let head = CircleRosterHead::signed(
        ...
        crate::sync::store_commit::SuccessorLink {
            activation: crate::sync::store_commit::StreamActivationId::from_digest(
...
fn control_authority_uses_the_pre_transition_roster_for_self_demotion() {
    ...
    let authority = MergeCircleOwnerAuthorityRef::Roster {
        roster: crate::sync::circle::MergeCircleRosterStateRef {
            heads: Vec::new(),
            resolutions: Vec::new(),
...
async fn current_state_reducer_retains_each_concurrent_control_branch() {
    ...
    ) -> crate::sync::circle::MergeCircleControlHeadRef {
        crate::sync::circle::MergeCircleControlHeadRef {
