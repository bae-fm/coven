...
fn verify_metadata_history(
    entries: &BTreeMap<crate::sync::circle::CircleMetadataCoord, CircleMetadata>,
    expected_heads: Option<&[crate::sync::circle::CircleMetadataCoord]>,
) -> Result<(), CircleOperationError> {
    let mut streams = BTreeMap::<
        crate::sync::circle::CircleAuthorStreamKey,
