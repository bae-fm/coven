...
impl<'a> StoreCommitVerifier<'a> {
    ...
    pub(super) async fn verify_terminal_candidate_head(
    ...
    ) -> Result<crate::sync::remote_object::VerifiedCandidateHead, StorePullError> {
            ...
            .await
        {
            Err(StorageError::NotFound(_)) => Ok(
                crate::sync::remote_object::VerifiedCandidateHead::ExactCandidateAbsent {
            ...
            {
                Ok(
                    crate::sync::remote_object::VerifiedCandidateHead::ExactLateCandidate {
                        object: candidate_head_object.clone(),
                    },
                )
            }
    ...
    pub(crate) async fn verify_author_exclusion_nonactivation(
        ...
        candidate_head: &StoreDeviceHead,
        candidate_head_object: &ExactObjectRef,
    ) -> Result<crate::sync::remote_object::VerifiedCandidateNonactivation, StorePullError> {
        ...
        .map_err(|error| StorePullError::Database(error.to_string()))?;
        crate::sync::remote_object::VerifiedCandidateNonactivation::from_verified_author_exclusion(
            durable,
            candidate_ref.clone(),
