...
fn nonactivation_commit(
    nonactivation: &crate::sync::remote_object::CandidateNonactivation,
) -> Result<crate::sync::store_commit::StoreBatchCommit, String> {
    nonactivation
        .validate()
...
fn request_has_closed_shape(
    ...
    request.version == crate::sync::store_commit::STORE_PROTOCOL_VERSION
        ...
        && request.intended_owner_grant
            == crate::sync::store_commit::derive_owner_promotion_grant(
...
fn transition_matches_acceptance(
    transition: &PreparedMembershipTransition,
    wrapped_key: &crate::sync::wrapped_store_key::WrappedStoreKeyRef,
    acceptance: &OwnerPromotionAcceptance,
) -> bool {
    ...
    crate::sync::store::membership::validate_prepared_transition(transition).is_ok()
...
fn finalization_receipt_matches_acceptance(
...
) -> bool {
    {
        ...
        let crate::sync::membership::MembershipChange::SetMember { wrapped_key, .. } =
        ...
        crate::sync::store::membership::validate_prepared_publication(publication).is_ok()
        ...
        let valid = match &self.state {
            ...
            OwnerPromotionJournalState::MergeHeadPrepared {
                ...
                acceptance_has_closed_shape(self.promotion_id, &self.target, acceptance)
                    ...
                    && crate::sync::store::membership::validate_prepared_publication(publication)
                        .is_ok()
...
impl OwnerPromotionJournalPredecessor {
    pub(super) fn transition_to(
        &self,
        next: &OwnerPromotionJournal,
        remote_objects: Vec<crate::sync::remote_object::RemoteObjectRecord>,
