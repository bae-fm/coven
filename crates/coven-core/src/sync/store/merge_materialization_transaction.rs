...
pub(super) struct MergeMaterializationTransaction<'transaction, 'connection> {
...
impl MergeMaterializationTransaction<'_, '_> {
    ...
    pub(super) fn record_verified_merge_materialization(
        &self,
    ...
    pub(super) fn record_verified_circle_activations(
        &self,
        verified_commit: &VerifiedStoreBatchCommit,
    ...
    pub(super) fn activate_store_operation_remote_objects(
        &self,
