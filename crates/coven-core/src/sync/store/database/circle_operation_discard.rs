...
use crate::sync::circle::{CircleAccessDisposition, CircleOperationId};
use crate::sync::remote_object::remote_object_id;
use crate::sync::storage::ExactObjectRef;
use crate::sync::store::circle_controls::{CircleOperationJournal, PreparedCircleOperation};
        ...
        self.database
            .call(move |conn| {
                ...
                for object_id in object_ids {
                    ...
                    if matches!(
                        remote,
                        crate::sync::remote_object::RemoteObjectRecord::CandidateCommit(
                        ...
                        ) | crate::sync::remote_object::RemoteObjectRecord::CandidateExclusive(
