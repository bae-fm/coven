...
impl Store {
    ...
    pub(crate) async fn create(
        ...
        let protocol_root = match Box::pin(
            crate::sync::store::protocol_root::publish_store_founder_graph(
                &database,
                &*storage,
                founder_timestamp,
                identity,
    ...
    > {
        ...
        crate::sync::store::circle_controls::activation::load_circle_activations(
            &self.database,
