...
pub struct DeviceJoinAttempt {
    ...
    pub provider_approval: crate::sync::store::device_join::DeviceProviderAdmissionApproval,
    pub provider_response: crate::sync::store::device_join::DeviceProviderResponseReservation,
...
struct DeviceJoinAttemptSignedFields<'a> {
    ...
    provider_approval: &'a crate::sync::store::device_join::DeviceProviderAdmissionApproval,
    provider_response: &'a crate::sync::store::device_join::DeviceProviderResponseReservation,
...
impl DeviceJoinAttempt {
    ...
    pub fn signed(
        ...
        provider_approval: crate::sync::store::device_join::DeviceProviderAdmissionApproval,
        provider_response: crate::sync::store::device_join::DeviceProviderResponseReservation,
    ...
    fn validate_shape(&self) -> Result<(), StoreProtocolError> {
        ...
        match (&self.provider_approval.admission, &self.provider_response) {
            ...
            | (
                ...
                crate::sync::store::device_join::DeviceProviderResponseReservation::CrossPrincipal {
                    ..
                },
            ) => {}
