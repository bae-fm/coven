...
pub(in crate::sync::store_engine) async fn find_request_activation(
    ...
    if !matches!(
        ...
        return Err(StorePullError::Database(
            "Merge Owner-promotion discovery received Serial finalization".to_string(),
        ));
    }
    ...
    Ok(super::store_commit::OwnerPromotionRequestActivation::MergeConcurrent { commit, head })
}
