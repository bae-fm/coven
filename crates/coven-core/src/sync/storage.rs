...
/// scheme carries the signed uploader and generation in a provider-safe prefix.
///
...
pub trait SyncStorage: crate::MaybeThreadSafe {
    ...
    /// This device's upload identity. Blob locations use it as authenticated provenance.
