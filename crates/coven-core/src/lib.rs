...
pub use sync::device_join::{
    ...
    load_current_device_join_authorization, load_pending_device_join_status,
    load_store_device_join_status, observe_device_join_abandonment, observe_device_join_activation,
    prepare_device_join_cleanup, prepare_device_provider_access_request,
    prepare_device_registration_request, publish_device_provider_challenge,
    revoke_device_provider_admission_writes, revoke_joining_device_writes, DeviceJoinAbandonment,
    DeviceJoinAction, DeviceJoinActivation, DeviceJoinAuthorization, DeviceJoinCancellation,
    ...
    DeviceJoinProducer, DeviceJoinProducerWriteRevocation, DeviceJoinRole, DeviceJoinStatus,
